...
//                /*10*/{new Integer[]{1, 2, 1}, 2, 3},
//                /*11*/{new Integer[]{2, 1, 1}, 2, 2},
//                /*12*/{new Integer[]{2, 1, 2}, 2, 3},
...
//                /*18*/{new Integer[]{1, 1, 2, 5}, 4, 5},
                /*19*/{new Integer[]{2, 1, 1, 2}, 2, 3},/*5*/
                /*20*/{new Integer[]{1, 2, 1, 1}, 3, 2},/*1*/
                /*21*/{new Integer[]{1, 2, 3, 4}, 4, 4},
                /*22*/{new Integer[]{9, 5, 2, 4, 10}, 2, 16},/*29*/
                /*23*/{new Integer[]{9, 5, 2, 4, 10}, 3, 11},/*13*/
                /*24*/{new Integer[]{9, 5, 2, 4, 10}, 4, 10},/*9*/
                /*25*/{new Integer[]{9, 5, 2, 4, 10}, 5, 10},
                /*26*/{new Integer[]{9, 5, 10, 4, 1}, 2, 15},/*28*/
                /*27*/{new Integer[]{9, 5, 10, 4, 1}, 3, 14},/*23*/
                /*28*/{new Integer[]{9, 5, 10, 4, 1}, 4, 10},/*23*/
