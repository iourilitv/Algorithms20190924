...
public class MainDP {
    public static void main(String[] args) {
        ...
        //columns: [1, 2, 3]
        //rows[0]=book={weight=1, cost=3}: [Knapsack{capacity=1, thingsInside=[book={weight=1, cost=3}], weightOfThingsInside=1, costOfThingsInside=3}, Knapsack{capacity=2, thingsInside=[book={weight=1, cost=3}], weightOfThingsInside=1, costOfThingsInside=3}, Knapsack{capacity=3, thingsInside=[book={weight=1, cost=3}], weightOfThingsInside=1, costOfThingsInside=3}]
        //rows[1]=jacket={weight=2, cost=5}: [Knapsack{capacity=1, thingsInside=[book={weight=1, cost=3}], weightOfThingsInside=1, costOfThingsInside=3}, Knapsack{capacity=2, thingsInside=[jacket={weight=2, cost=5}], weightOfThingsInside=2, costOfThingsInside=5}, Knapsack{capacity=3, thingsInside=[jacket={weight=2, cost=5}, book={weight=1, cost=3}], weightOfThingsInside=3, costOfThingsInside=8}]
        //rows[2]=camera={weight=1, cost=6}: [Knapsack{capacity=1, thingsInside=[camera={weight=1, cost=6}], weightOfThingsInside=1, costOfThingsInside=6}, Knapsack{capacity=2, thingsInside=[camera={weight=1, cost=6}, book={weight=1, cost=3}], weightOfThingsInside=2, costOfThingsInside=9}, Knapsack{capacity=3, thingsInside=[camera={weight=1, cost=6}, jacket={weight=2, cost=5}], weightOfThingsInside=3, costOfThingsInside=11}]
        //rows[3]=water={weight=3, cost=10}: [Knapsack{capacity=1, thingsInside=[camera={weight=1, cost=6}], weightOfThingsInside=1, costOfThingsInside=6}, Knapsack{capacity=2, thingsInside=[camera={weight=1, cost=6}, book={weight=1, cost=3}], weightOfThingsInside=2, costOfThingsInside=9}, Knapsack{capacity=3, thingsInside=[camera={weight=1, cost=6}, jacket={weight=2, cost=5}], weightOfThingsInside=3, costOfThingsInside=11}]
        //rows[4]=food={weight=2, cost=9}: [Knapsack{capacity=1, thingsInside=[camera={weight=1, cost=6}], weightOfThingsInside=1, costOfThingsInside=6}, Knapsack{capacity=2, thingsInside=[camera={weight=1, cost=6}, book={weight=1, cost=3}], weightOfThingsInside=2, costOfThingsInside=9}, Knapsack{capacity=3, thingsInside=[camera={weight=1, cost=6}, food={weight=2, cost=9}], weightOfThingsInside=3, costOfThingsInside=15}]
        //
